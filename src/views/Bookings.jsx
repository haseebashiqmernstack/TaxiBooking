...
import { ShowBooking } from '../redux/actions/bookingAction';
             ...
             <tbody>
               {
                 RideBooking.booking.map((ride)=>(
                     <tr>
                       ...
                       <td><button style={{margin:"0 5px"}} className="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Confirm Ride"><CheckIcon/></button>
